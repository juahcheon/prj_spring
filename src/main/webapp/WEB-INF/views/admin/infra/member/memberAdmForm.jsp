...
<body>
	                    ...
	                    <table class="did_theme_table">
	                        ...
	                        <tbody>
	                            <tr>
								  ...
								  <td><input placeholder="local" name="local" id="local" value="<c:out value="${item.local}"/>"/></td>
								  <td></td>
								  <td></td>
								</tr>
    ...
    <script>
	    ...
	    $(".saveBtn").on("click",function(){
	        ...
	        $("form[name=subForm]").attr("action","/memberUpdt2").submit();
	    });
	
	    $(".delBtn").on("click",function(){
	    	if (validationDelt() == false) return false;
	        $("form[name=subForm]").attr("action","/memberDelt2").submit();
	    });
	    
	    $(".makeBtn").on("click",function(){
	    	/* if (validationUpdt() == false) return false; */
	        $("form[name=subForm]").attr("action","/memberNsrt2").submit();
	    });
    </script>
